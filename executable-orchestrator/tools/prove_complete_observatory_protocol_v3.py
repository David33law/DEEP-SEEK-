...
and the canonical localhost provider. Only after that receipt passes does the hardened disposable-
clone Docker E2E execute. Neither phase contacts the real DeepSeek endpoint.
"""
